...
export function LogoIcon({ className = "w-8 h-8", ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      ...
      <path d="M19 8v6" stroke="#10b981" strokeWidth="2.5" />
      <path d="M16 11h6" stroke="#10b981" strokeWidth="2.5" />
    </svg>
  );
}
...
export function FlameIcon({ className = "w-5 h-5", ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function MessageSquareIcon({ className = "w-5 h-5", ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
